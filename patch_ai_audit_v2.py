...
# -*- coding: utf-8 -*-
"""
Патч main.py для добавления AI аудита при отправке анкеты - V2
Исправлен под фактический код production
"""
...
# Backup
with open(MAIN_PY + '.backup_ai_audit_v2', 'w', encoding='utf-8') as f:
    f.write(content)
print(f"✅ Backup: {MAIN_PY}.backup_ai_audit_v2")

# Патчим send_anketa_to_processing - добавляем AI audit ПЕРЕД try блоком
...
# Патчим success_text чтобы включить AI audit результат
