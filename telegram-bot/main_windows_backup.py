...
# -*- coding: utf-8 -*-
"""
ГрантСервис - Telegram Bot с интерактивным меню (Windows версия)
...
# Добавляем путь к модулю БД - для Windows
...
log_dir = 'C:\\SnowWhiteAI\\GrantService\\logs'
...
"""
    ...
    def run(self):
        ...
        if not self.token:
            ...
            logger.error("Или добавьте её в файл C:\\SnowWhiteAI\\GrantService\\config\\.env")
            return
        ...
        # Запускаем бота
        logger.info("Бот запущен с интерактивным меню (Windows версия)")
...
if __name__ == "__main__":
    ...
    env_path = 'C:\\SnowWhiteAI\\GrantService\\config\\.env'
